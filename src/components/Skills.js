...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex item-center justify center rounded-full font-semibold bg-dark text-light first-letter 
...
const Skills = () => {
  return (
    <>
      ...
      rounded-full bg-circularLight dark:bg-circularDark lg:h-[80hv] sm:h-[60vh] xs:h-[50vh]
      ...
      p-8 shadow-dark cursor-pointer dark:text-dark dark:bg-light lg:p-6 md:p-4 xs:text-xs xs:p-2"
        ...
        <Skill name="ReacJS" x="0vw" y="14vw" />
        <Skill name="NextJS" x="-20vw" y="-15vw" />
        <Skill name="Java" x="15vw" y="-12vw" />
        <Skill name="Web Design" x="32vw" y="-5vw" />
        <Skill name="C and C++" x="0vw" y="-20vw"/>
